<template>
  <div class="service-detail">
    <div class="service-header">
      <div class="container">
        <h1>Consultoría Legal, Contable e Impositiva</h1>
        <div class="icon">
    ...
    <div class="container content">
      <div class="service-content" data-aos="fade-up">
        ...
        <ul>
          <li>Asesoramiento legal en operaciones financieras</li>
          <li>Planificación fiscal y tributaria</li>
          <li>Gestión contable y reportes financieros</li>
          <li>Cumplimiento normativo y regulatorio</li>
          <li>Estructuración de operaciones complejas</li>
        </ul>

        <h2>Beneficios</h2>
        <ul>
          <li>Minimización de riesgos legales</li>
          <li>Optimización fiscal</li>
          <li>Información contable confiable</li>
          <li>Cumplimiento regulatorio</li>
          <li>Soporte profesional integral</li>
        </ul>
